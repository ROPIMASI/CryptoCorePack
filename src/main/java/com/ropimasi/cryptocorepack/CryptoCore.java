 ...
 * 
 * The CryptoCorePack and its resources are a personal proprietary project sample, which I have developing to demonstrate some of my abilities: java, oop, mvc, scrum, kanban, git, github, gitflow.
 * The CryptoCorePack project belongs to my personal portfolio. Detailed project can be followed on GitHub: https://github.com/users/ROPIMASI/projects/. It is also found on my web portfolio: https://ropimasi.wixsite.com/portfolio.
 * 
 * AUTHOR: RONALDO PI MA SI.
 * LICENSE: PRIVATE PROPRIETARY (either copy or usage are prohibited).
 * 
 * DESCRIPTION:
